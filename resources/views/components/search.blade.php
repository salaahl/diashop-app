            ...
            <div
                ...
                <form id="search-form" action="/search" method="POST" class="w-full">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="search-input" class="block w-full mt-6 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Rechercher un article" required>
                    </div>
