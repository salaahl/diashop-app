<section id="search-container" class="h-0 w-full flex flex-col justify-between absolute left-0 z-10 overflow-hidden">
    <div class="w-full">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-full mt-5 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Rechercher un article" required>
            <button type="submit" id="default-search-btn" class="text-white absolute end-2.5 bottom-2.5 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Voir plus</button>
        </div>
    </div>
