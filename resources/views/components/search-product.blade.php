<section id="search-container" class="h-0 w-full flex flex-col justify-between absolute left-0 overflow-hidden">
    <div class="w-full">
        ...
        <div class="relative">
            ...
            <button type="submit" id="default-search-btn" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Voir plus</button>
        </div>
    </div>
    <div id="search-results" class="h-full w-full flex flex-wrap lg:items-center max-lg:mt-10 overflow-auto lg:overflow-hidden"></div>
    <div id="lds-hourglass" class="hidden h-full w-full absolute left-0 right-0 justify-center items-center"></div>
