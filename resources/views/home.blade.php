...
<section id="product-of-the-week-container" class="max-w-[1280px] flex flex-wrap justify-between md:flex-nowrap flex-col md:flex-row mx-auto mt-[10px] md:mt-32 px-[10px]">
