...
<section id="products-container" class="">
    <div id="headers">
        <h1>Nouveautés</h1>
...
<section id="catalogs-container" class="">
    <article class="catalog">
        <a href="{{ route('woman.catalog') }}">
            <div class="catalog-inner">
                <img src="{{ asset('/images/woman_catalog-placeholder.jpg') }}" class="" alt="...">
            </div>
    ...
    <article class="catalog">
        <a href="{{ route('men.catalog') }}">
            <div class="catalog-inner">
                <img src="{{ asset('/images/man_catalog-placeholder.jpg') }}" class="" alt="...">
            </div>
            <h3 class="uppercase">Catalogue homme</h3>
        </a>
    </article>
</section>
<section id="aboutme-container" class="">
    ...
    <div class="text-container text-justify">
        <h2 class="text-justify text-5xl w-min mb-4 p-4 bg-gray-800 text-white uppercase">A propos de nous</h2>
...
<section id="instagram-container" class="">
