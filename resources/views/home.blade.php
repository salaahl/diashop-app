...
<div class="strip">
    <section id="new-products-container" class="md:flex flex-nowrap md:mt-16 mx-auto py-4 px-[10px] bg-white md:bg-gray-100 md:rounded-lg overflow-auto xl:overflow-hidden">
        <div class="title-container">
            <h2><span>Nouveautés</span></h2>
        </div>
        <div id="new-products" class="flex flex-nowrap px-8 md:px-0">
