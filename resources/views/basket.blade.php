...
<div class="min-h-screen w-full mt-[-80px] pt-[80px]">
    ...
    <div class="max-md:min-h-[50vh] flex max-md:flex-col max-md:flex-wrap justify-between">
        ...
        <div class="md:h-[100vh] md:min-w-[20%] lg:min-w-[30%] max-md:w-full flex flex-col justify-between items-center md:h-screen mt-10 md:mt-[-110px] md:mb-[25px] md:pt-[110px] md:pb-[10px] sticky top-[-30px]">
            <form class="w-full">
                        ...
                        <tbody>
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <td class="p-4">
                                    ...
                                    @if($total > 49)
                                    <h4 class="text-sm text-gray-500 line-through">+ 4.99€ de frais de livraison</h4>
                                    <h4 class="text-sm text-gray-500">Frais de livraison offerts !</h4>
                                    @else
