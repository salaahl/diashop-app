...
<div>
    ...
    <form action="{{ route('store.category') }}" enctype="multipart/form-data" method="POST">
        ...
        <div>
            ...
            <input aria-describedby="img_thumbnail_input_help" id="img_thumbnail" type="file" name="img_thumbnail" accept="image/png, image/jpg, image/jpeg, image/gif" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none">
        </div>
