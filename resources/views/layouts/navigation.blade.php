    ...
    <div class="h-full w-full max-w-screen-xl flex flex-wrap items-center justify-end lg:justify-between mx-auto max-[1023px]-px-4 xl:p-0">
        ...
        <div class="h-full w-full lg:flex lg:justify-between" id="navbar-dropdown">
            ...
            <ul class="flex flex-col lg:items-center font-medium p-4 lg:p-0 mt-4 max-lg:rounded-b-lg border border-gray-100 max-lg:bg-gray-50 lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0">
                @auth
                <li class="h-full w-full lg:flex lg:justify-center lg:items-center">
                    <a href="{{ route('dashboard') }}" id="dashboardLink" class="hidden lg:flex max-lg:justify-between items-center w-full p-2 whitespace-nowrap text-gray-900 text-sm uppercase rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:p-0 lg:w-auto">
