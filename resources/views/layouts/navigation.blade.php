    ...
    <div class="h-full w-full max-w-screen-xl flex flex-wrap items-center justify-end lg:justify-between mx-auto max-[1023px]-px-4 xl:p-0">
        ...
        <div class="h-full w-full lg:flex lg:justify-between" id="navbar-dropdown">
            ...
            <ul class="flex flex-col lg:items-center font-medium p-4 lg:p-0 mt-4 max-lg:rounded-lg border border-gray-100 max-lg:bg-gray-50 lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0">
                ...
                @endauth
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <button id="search-btn" class="w-full flex py-2 px-3 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0  lg:p-0"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="22" viewBox="0 0 512 512" class="lg:hidden">

                            <path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" />
                        </svg><span class="whitespace-nowrap ml-5 lg:m-0">Rechercher</span></button>
                </li>
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('basket.show') }}" class="flex py-2 px-3 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0  lg:p-0"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="22" viewBox="0 0 576 512" class="lg:hidden">
                ...
                @guest
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('login') }}" class="flex align-center py-2 px-3 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0  lg:p-0"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="18" viewBox="0 0 448 512" class="lg:hidden">
                ...
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <form method="POST" action="/logout">
                        @csrf
                        <a href="#" class="flex align-center py-2 px-3 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0  lg:p-0" onclick="event.preventDefault(); this.closest('form').submit();"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512" class="lg:hidden">
