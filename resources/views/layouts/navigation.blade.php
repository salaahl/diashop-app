        ...
        <div class="h-full w-full lg:flex lg:justify-between" id="navbar-dropdown">
            <ul class="flex flex-col items-center font-medium p-4 lg:p-0 max-lg:rounded-lg border border-gray-100 max-lg:bg-gray-50 lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0">
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('woman.catalog') }}" id="dropdownNavbarLinkWoman" class="hidden lg:flex items-center justify-between w-full py-2 px-3 uppercase text-gray-900 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 lg:w-auto">Femme</a>
                    <button id="dropdownNavbarLinkWomanBtn" data-collapse-toggle="dropdownNavbarWoman" type="button" class="lg:hidden flex items-center justify-between w-full py-2 px-3 uppercase text-gray-900 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 lg:w-auto">Femme
                ...
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('men.catalog') }}" id="dropdownNavbarLinkMen" class="hidden lg:flex items-center justify-between w-full py-2 px-3 uppercase text-gray-900 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 lg:w-auto">Homme</a>
                    <button id="dropdownNavbarLinkMenBtn" data-collapse-toggle="dropdownNavbarMen" type="button" class="lg:hidden flex items-center justify-between w-full py-2 px-3 uppercase text-gray-900 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 lg:w-auto">Homme
                        <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                        </svg></button>
                    <!-- Dropdown menu -->
            ...
            <ul class="flex flex-col lg:items-center font-medium p-4 lg:p-0 mt-4 max-lg:rounded-lg border border-gray-100 max-lg:bg-gray-50 lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0">
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('basket.show') }}" class="flex py-2 px-3 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="22" viewBox="0 0 576 512" class="lg:hidden">
                ...
                @guest
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('login') }}" class="flex align-center py-2 px-3 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="18" viewBox="0 0 448 512" class="lg:hidden">
                ...
                @auth
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('dashboard') }}" class="flex py-2 px-3 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="18" viewBox="0 0 448 512" class="lg:hidden">

                            <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
                        </svg><span class="whitespace-nowrap ml-5 lg:m-0">Mon profil</span></a>
                </li>
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <form method="POST" action="/logout">
                        @csrf
                        <a href="#" class="flex align-center py-2 px-3 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0" onclick="event.preventDefault(); this.closest('form').submit();"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512" class="lg:hidden">
