            ...
            <ul class="flex flex-col lg:items-center font-medium p-4 lg:p-0 mt-4 max-lg:rounded-b-lg border border-gray-100 max-lg:bg-gray-50 lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0">
                ...
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <button id="search-btn" class="w-full flex py-2 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0 lg:p-0">
                        <span class="text-sm uppercase whitespace-nowrap ml-5 lg:m-0">Rechercher</span>
                ...
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('basket.show') }}" class="flex py-2 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0  lg:p-0">
                        <span class="text-sm uppercase whitespace-nowrap ml-5 lg:m-0">Panier</span>
                ...
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <a href="{{ route('login') }}" class="flex align-center py-2 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0  lg:p-0">
                        <span class="text-sm uppercase whitespace-nowrap ml-5 lg:m-0">Se connecter</span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="20" width="18" viewBox="0 0 448 512" class="lg:hidden">
                ...
                <li class="h-full w-full lg:flex lg:items-center lg:flex lg:align-center">
                    <form method="POST" action="/logout">
                        ...
                        <a href="#" class="flex align-center py-2 text-gray-900 rounded hover:bg-gray-300 lg:hover:bg-transparent lg:border-0  lg:p-0" onclick="event.preventDefault(); this.closest('form').submit();">
                            <span class="text-sm uppercase whitespace-nowrap ml-5 lg:m-0">Se déconnecter</span>
