<section>
    <div id="garanties-container" class="w-full max-w-screen-2xl flex flex-nowrap mx-auto pt-6">
        <div class="w-1/4 flex flex-col xl:flex-row items-center justify-start xl:justify-center px-2 py-4 text-sm text-center text-gray-500 font-semibold md:border-r-4 md:border-gray-300">Livraison gratuite à partir de {{ env('VITE_FREE_SHIPPING') / 100 }}€</div>
