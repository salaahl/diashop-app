...
<!-- Modal -->
<div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-hidden fixed top-0 right-0 left-0 z-[999] justify-center items-center h-full w-full md:inset-0 max-h-full bg-black/50 backdrop-blur-[2px]">
    <div class="relative max-h-full">
        <div class="relative shadow-2xl overflow-hidden">
            <!-- Close modal button -->
            <button type="button" class="absolute right-0 text-white bg-gray-800 rounded-full text-sm w-8 h-8 m-2 inline-flex justify-center items-center" data-modal-hide="default-modal">
